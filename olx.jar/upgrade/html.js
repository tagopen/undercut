...
{
  chrome.tabs.create({ url: "http://chrispederick.com/work/web-developer/firefox/installed/" + version + "/" });
};
...
WebDeveloper.Upgrade.upgrade = function()
{
  ...
  if(previousVersion != "2.0.1")
  {
    WebDeveloper.Storage.setItem("version", "2.0.1");
    // WebDeveloper.Upgrade.openUpgradeURL("2.0.1");
